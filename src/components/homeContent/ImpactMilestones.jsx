            ...
            <div className="max-w-7xl mx-auto px-6">
                ...
                <div className="flex flex-col md:flex-row items-end justify-between mb-16 gap-4">
                    <div className="max-w-xl">
                        <h2 className="text-teal-600 font-bold tracking-[0.3em] uppercase text-xs mb-3">
                            Impact & Reach
                        </h2>
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-auto md:auto-rows-[240px]">
                    ...
                    >
                        ...
                        <div className="relative h-full p-8 md:p-10 flex flex-col justify-end">
                            <div className="text-5xl md:text-6xl font-black text-white mb-2">{stats[0].value}</div>
                            <h3 className="text-xl md:text-2xl font-bold text-teal-300 mb-4">{stats[0].label}</h3>
                    ...
                    >
                        ...
                        <div className="w-full sm:w-2/3 p-6 md:p-8 flex flex-col justify-center">
                            <div className="text-3xl md:text-4xl font-black text-teal-600 mb-1">{stats[1].value}</div>
                            <h3 className="text-xl font-bold text-slate-900 mb-2">{stats[1].label}</h3>
                            <p className="text-slate-500 text-xs md:text-sm leading-relaxed">{stats[1].desc}</p>
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="flex-1 text-center sm:text-left">
                            <div className="text-3xl md:text-4xl font-black text-teal-600 mb-1">{stats[2].value}</div>
                            <h3 className="text-lg md:text-xl font-bold text-slate-900 mb-2">{stats[2].label}</h3>
                            <p className="text-slate-500 text-xs md:text-sm leading-relaxed max-w-sm mx-auto sm:mx-0">
                                {stats[2].desc}
                            </p>
                        </div>
