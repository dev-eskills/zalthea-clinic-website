                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    {doctors.slice(0, 2).map((doctor, i) => (
                        <motion.div
                            ...
                            onClick={() => navigate(doctor.value === "ctvs" ? '/cardiology' : '/ent')}
                        >
                            ...
                            <div className="w-full sm:w-[40%] relative aspect-[4/5] sm:aspect-auto overflow-hidden bg-slate-50">
                                ...
                                <div className="absolute top-4 left-4">
                                    <span className="bg-teal-600 text-white text-[9px] font-black uppercase px-2 py-1 tracking-tighter shadow-sm rounded">
                                        {doctor.value}
                                    </span>
                                </div>
                            </div>
                            ...
                            <div className="w-full sm:w-[60%] p-6 md:p-8 flex flex-col justify-between">
                                <div className="relative pl-6 border-l-2 border-slate-100 group-hover:border-teal-500 transition-colors duration-500">
                                    ...
                                    <div className="space-y-1">
                                        <p className="text-[10px] text-slate-400 font-mono uppercase">{doctor.regNo}</p>
                                        <p className="text-[10px] text-teal-700/70 font-bold uppercase">{doctor.hospital}</p>
                                    </div>
                                </div>
