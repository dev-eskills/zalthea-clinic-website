      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="max-w-2xl">
            <h2 className="text-teal-600 font-bold uppercase tracking-wide text-[10px] mb-4">
              Patient Success
            </h2>
            <p className="text-4xl font-light text-slate-900 leading-tight">
              Clinical Outcomes &{" "}
              <span className="font-bold">Patient Trust</span>
            </p>
          </div>
          <div className="flex items-center gap-2 text-slate-400 text-sm italic border-l-2 border-teal-500 pl-4">
            99% Patient Satisfaction Rate based on 2,500+ procedures.
          </div>
        </div>
              ...
              <div className="relative z-10">
                ...
                <div className="flex items-center gap-4 pt-6 border-t border-slate-50">
                  <img
                    src={rev.image}
                    alt="rev"
                    className="w-12 h-12 bg-slate-100 bg-cover rounded-full flex items-center justify-center font-bold text-teal-700"
                  />
                  <div>
                    <h4 className="text-slate-900 font-bold text-sm">
                      {rev.patient}
                    </h4>
                    {/* <p className="text-teal-500 text-[10px]  uppercase tracking-wider">
